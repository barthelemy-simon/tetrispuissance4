public class FormeT extends Forme {
	...
	public FormeT(int posX, int posY, int[] remplissage, int rotation) {
		this.posX = posX;
		this.posY = posY;
	...
	public FormeT() {
		this((int)(TetrisPuissance4NonGraphique.LARGEUR/2), 3, remplissageAleatoire(), 0);
	}
	
	public Forme clone() {
		return new FormeT(this.posX, this.posY, this.remplissage, this.rotation);
	}
